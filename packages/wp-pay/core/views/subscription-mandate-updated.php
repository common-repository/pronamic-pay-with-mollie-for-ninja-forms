	...
	<body>
		<div class="pronamic-pay-redirect-page">
			<div class="pronamic-pay-redirect-container alignleft">
				<p>
					<?php esc_html_e( 'The subscription has been updated.', 'pronamic-pay-with-mollie-for-ninja-forms' ); ?>
				</p>

				<p>
					<a href="<?php echo esc_url( home_url() ); ?>">
						<?php esc_html_e( 'Return to home page', 'pronamic-pay-with-mollie-for-ninja-forms' ); ?>
					</a>
				</p>
			</div>
		</div>

...
class Extension extends AbstractPluginIntegration {
	...
	public function __construct() {
		parent::__construct(
			[
				'name' => __( 'Ninja Forms', 'pronamic-pay-with-mollie-for-ninja-forms' ),
			]
		);
	...
	public function field_type_sections( $sections ) {
		$sections['pronamic_pay'] = [
			'id'         => 'pronamic_pay',
			'nicename'   => __( 'Pronamic Pay', 'pronamic-pay-with-mollie-for-ninja-forms' ),
			'fieldTypes' => [],
		];
	...
	public function source_text( $text, Payment $payment ) {
		$text = __( 'Ninja Forms', 'pronamic-pay-with-mollie-for-ninja-forms' ) . '<br />';
		...
		if ( 'nf_sub' === get_post_type( $source_id ) ) {
			$text .= sprintf(
				...
				sprintf( __( 'Entry #%s', 'pronamic-pay-with-mollie-for-ninja-forms' ), $source_id )
			);
		} else {
			/* translators: %s: payment source id */
			$text .= sprintf( __( '#%s', 'pronamic-pay-with-mollie-for-ninja-forms' ), $source_id );
		}
	...
	public function source_description( $description, Payment $payment ) {
		$description = __( 'Ninja Forms', 'pronamic-pay-with-mollie-for-ninja-forms' );
		...
		if ( 'nf_sub' === get_post_type( $source_id ) ) {
			$description = __( 'Ninja Forms Entry', 'pronamic-pay-with-mollie-for-ninja-forms' );
		}
